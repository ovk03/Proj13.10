...
class CameraRenderOptimized(metaclass=EngineTypeSingleton):
    ...
    def render3d(self, buffer=None, cache: bool = False) -> bool:
        ...
        length=len(buffer)
        if RENDER_CORE_COUNT > 1:
            cores=[]
            buffers=[]
            p=multiprocessing.Pool(RENDER_CORE_COUNT)
            for i in range(RENDER_CORE_COUNT):
                start=round(i/RENDER_CORE_COUNT*length)
                stop=round((i+1)/RENDER_CORE_COUNT*length)
                cores.append(p.apply_async(self.multi_core_rendrer,(buffer[start:stop],)))

            tcl_code = [i.get() for i in cores]
            return GameToTK().draw_code("")
            """really complicated and unreadable code, but REALLY OPTIMIZED for rendering objects with tkinter
                            Input is tuple of form:
                            ((1,1,1),(1,1,1),(1,2,3))
        ...
        for tri in buffer:
            ...
            if (0.0 < point1_v4[2]) and \
                ...
                point1_v4 = (((point1_v4[0] / point1_v4[3] + 1) * screen_width / 2,
                              (point1_v4[1] / point1_v4[3] + 1) * screen_height / 2))
                point2_v4 = (((point2_v4[0] / point2_v4[3] + 1) * screen_width / 2,
                              (point2_v4[1] / point2_v4[3] + 1) * screen_height / 2))
                point3_v4 = (((point3_v4[0] / point3_v4[3] + 1) * screen_width / 2,
                              (point3_v4[1] / point3_v4[3] + 1) * screen_height / 2))
                point4_v4 = (((point4_v4[0] / point4_v4[3] + 1) * screen_width / 2,
                              (point4_v4[1] / point4_v4[3] + 1) * screen_height / 2))
                tcl_code.append(
                    f"{canvas} coords {count} {point1_v4[0]} {point1_v4[1]} {point2_v4[0]} {point2_v4[1]} "
                    f"{point3_v4[0]} {point3_v4[1]} {point4_v4[0]} {point4_v4[1]}\n"
                    f"{canvas} itemconfigure {count} -fill #{tri[12]:02x}{tri[13]:02x}{tri[14]:002x}\n")
                ...
                if (clip_count == 2 and ((c1 == c2) or (c1 == c4))) or clip_count == 3:
                    ...
                    point4_v4 = ((point4_v4[0] / point4_v4[3] + 1) * screen_width / 2,
                                 (point4_v4[1] / point4_v4[3] + 1) * screen_height / 2)
                    point5_v4 = ((point5_v4[0] / point5_v4[3] + 1) * screen_width / 2,
                                 (point5_v4[1] / point5_v4[3] + 1) * screen_height / 2)
                    point6_v4 = ((point6_v4[0] / point6_v4[3] + 1) * screen_width / 2,
                                 (point6_v4[1] / point6_v4[3] + 1) * screen_height / 2)
                    point7_v4 = ((point7_v4[0] / point7_v4[3] + 1) * screen_width / 2,
                                 (point7_v4[1] / point7_v4[3] + 1) * screen_height / 2)
                    point8_v4 = ((point8_v4[0] / point8_v4[3] + 1) * screen_width / 2,
                                 (point8_v4[1] / point8_v4[3] + 1) * screen_height / 2)
                    tcl_code.append(
                        f"{canvas} coords {count} {point1_v4[0]} {point1_v4[1]} {point2_v4[0]} {point2_v4[1]} "
                        f"{point3_v4[0]} {point3_v4[1]} {point4_v4[0]} {point4_v4[1]}\n"
                        f"{canvas} itemconfigure ¤ -fill #{tri[12]:02x}{tri[13]:02x}{tri[14]:002x}\n")
                    tcl_code.append(
                        f"{canvas} coords {count} {point5_v4[0]} {point5_v4[1]} {point6_v4[0]} {point6_v4[1]} "
    ...
    def single_core_rendrer(self,buffer):
        """really complicated and unreadable code, but REALLY OPTIMIZED for rendering objects with tkinter
                Input is tuple of form:
                ((1,1,1),(1,1,1),(1,2,3))
        ...
        for tri in buffer:
            ...
            if (0.0 < point1_v4[2]) and \
               ...
               (0.0 < point4_v4[2]):
                ...
                tcl_code.append(f"{canvas} coords {count} {point1_v4[0]} {point1_v4[1]} {point2_v4[0]} {point2_v4[1]} "
                                f"{point3_v4[0]} {point3_v4[1]} {point4_v4[0]} {point4_v4[1]}\n"
                                f"{canvas} itemconfigure {count} -fill #{tri[12]:02x}{tri[13]:02x}{tri[14]:002x}\n")
                ...
                if (clip_count == 2 and ((c1 == c2) or (c1 == c4))) or clip_count == 3:
                    ...
                    tcl_code.append(f"{canvas} coords {count} {point1_v4[0]} {point1_v4[1]} {point2_v4[0]} {point2_v4[1]} "
                                    f"{point3_v4[0]} {point3_v4[1]} {point4_v4[0]} {point4_v4[1]}\n"
                                    f"{canvas} itemconfigure ¤ -fill #{tri[12]:02x}{tri[13]:02x}{tri[14]:002x}\n")
                    tcl_code.append(f"{canvas} coords {count} {point5_v4[0]} {point5_v4[1]} {point6_v4[0]} {point6_v4[1]} "
                                    f"{point7_v4[0]} {point7_v4[1]} {point8_v4[0]} {point8_v4[1]}\n"
                                    f"{canvas} itemconfigure {count} -fill #{tri[12]:02x}{tri[13]:02x}{tri[14]:002x}\n")
    ...
    def multi_core_rendrer(self,buffer):
